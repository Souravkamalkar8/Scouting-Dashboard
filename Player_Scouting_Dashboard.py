...
def scouting_bar(player):
    ...
    ax2.text(51, -0.57, "Median", color="black", size="15", weight="normal")
    ...
    ax3.text(51, -0.57, "Median", color="black", size="15", weight="normal")
    ...
    ax4.text(51, -0.57, "Median", color="black", size="15", weight="normal")
    ...
    ax5.text(51, -0.57, "Median", color="black", size="15", weight="normal")
