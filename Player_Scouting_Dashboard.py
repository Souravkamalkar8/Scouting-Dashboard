...
def scouting_bar(player):
    ...
    ax2.text(50, -1.4, "Percentile", color="black", size="31", weight="normal")
    ...
    ax3.text(50, -1.4, "Percentile", color="black", size="31", weight="normal")
    ...
    ax4.text(50, -1.4, "Percentile", color="black", size="31", weight="normal")
    ...
    ax5.text(50, -1.4, "Percentile", color="black", size="31", weight="normal")
